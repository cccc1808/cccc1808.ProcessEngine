        ...
        {           
                ...
                services
                    ...
                    .AddTriggerServices(
                        ...
                        new TriggerRegistryDto(
                         ...
                         new TriggerRegistryDto(
                            new TriggerTypeUniqueDto(Services.RootTrigger.ChildTriggerHandler.Name, 0),
                            TriggerMetadataDto.Create<Services.RootTrigger.ChildTriggerHandler>()
                            )
                    )
            ...
            public async Task CleanEnvironmentAsync() 
            {
                await using (var scope = ServiceProvider.CreateAsyncScope())
                {
                    ...
                    // Reservation
                    {
                        var processReservationProvider = scope.ServiceProvider.GetRequiredService<IProcessQueueReserveProvider<Guid>>();
