...
using cccc1808.ProcessEngine.Model.StaticInstance.EF.Implementation.Storage.Configuration;
    ...
    public class TestDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
...

            {
                ...
                modelBuilder.Entity<StaticInstanceRegistrationDbEntity<Guid>>(
                    b =>
                    {
                        new StaticInstanceRegistrationDbEntityConfiguration<Guid>().Configure(b);
                        b.Property(e => e.Id).ValueGeneratedNever();
                    });
        ...
        public async Task TruncateAllAsync() 
        {
            ...
            await Database.ExecuteSqlRawAsync(@"TRUNCATE TABLE ""public"".""static_instance_deploy"" CASCADE", []);
            await Database.ExecuteSqlRawAsync(@"TRUNCATE TABLE ""public"".""static_instance_registration"" CASCADE", []);
        }
    }
}
