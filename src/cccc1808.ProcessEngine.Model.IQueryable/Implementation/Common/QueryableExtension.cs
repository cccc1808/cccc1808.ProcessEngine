...
namespace cccc1808.ProcessEngine.Model.IQueryable.Implementation.Common
{
    public static class QueryableExtension
    {
        public static IQueryable<T> JoinCollection<T, TItem>(
        ...
        private class ExpressionReplacer(IDictionary<Expression, Expression> replaceMap) : ExpressionVisitor
        {
