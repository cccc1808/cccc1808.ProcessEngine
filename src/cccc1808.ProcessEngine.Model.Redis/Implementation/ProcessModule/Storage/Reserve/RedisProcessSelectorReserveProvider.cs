...
{
    public class RedisProcessSelectorReserveProvider
        : IProcessSelectorReserveProvider
    {
        ...
        public RedisProcessSelectorReserveProvider(
        ...
        public async Task<IProcessSelectorReserveProvider.IReserveScope> TryReserveAsync(
            ...
            CancellationToken cancellationToken)
        {
            ...
            var key = new RedisKey(_option.KeyFactory(processTypeUniqueDto));
        ...
        public class OptionDto
        {
            ...
            public required Func<ProcessTypeUniqueDto, string> KeyFactory { get; set; }
        }

        public class ReserveScope
            : IProcessSelectorReserveProvider.IReserveScope
        {
